  ...
  # dragon, but you can' t ask him whether he' s hungry.)
    ...
    def passage_of_time
      ...
      if @stuff_in_intestine >= 10
        @stuff_in_intestine = 0
        puts "Whoooops! #{@name} had an accident..."
      end
      if hungry?
        if @asleep
          @asleep = false
...
action = nil
puts "You are going to become a parent. What do you want to call your Dragon?"
name = gets.chomp
pet = Dragon.new name
while action != "EXIT"
  ...
  if pet.respond_to? action
    ...
    puts "What are you trying to do? You can toss, feed, walk and put_to_bed. Cancel with typing EXIT."
  end
end
if action == "EXIT"
  exit
